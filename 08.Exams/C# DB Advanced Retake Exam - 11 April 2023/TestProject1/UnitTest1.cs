...
public class Model_000_001
{
    ...
    {
        var context = GetType("InvoicesContext");

        var dbSetData = new[]
        {
            new DbSetInfo("Addresses", "Address", "Id StreetName StreetNumber PostCode City Country ClientId Client".Split()),
            new DbSetInfo("Clients", "Client", "Id Name NumberVat Addresses Invoices ProductsClients".Split()),
            new DbSetInfo("Invoices", "Invoice", "Id Number IssueDate DueDate Amount CurrencyType ClientId Client".Split()),
            new DbSetInfo("Products", "Product", "Id Name Price CategoryType ProductsClients".Split()),
            new DbSetInfo("ProductsClients", "ProductClient", "ProductId Product ClientId Client".Split()),
        };
